...
const Form = (props) => {
    ...
    return (
        <>
            <div className='bg-white/70 rounded-lg absolute m-auto left-[35%] border shadow-md shadow-slate-400 w-[450px] h-[500px]'>
                <h1 className='Title text-[1.4rem] text-center mb-2 text-blue-500 mt-2'>SignUp Your Detail</h1>
                ...
                <form className='col-span-1 px-10' onSubmit={props.SubmitForm}>
                    <div className="RestaurantName flex flex-col mt-4 relative">
                    ...
                    <div className="PhoneNumber flex flex-col my-2 relative">
                    ...
                    <div className="Password flex flex-col relative my-2">
                    ...
                    <div className="Confirm-Password flex flex-col relative">
                    ...
                    <div className="formButton ">
                        <button type='submit' className='w-full h-[2.5rem] bg-blue-500 text-white rounded-md text-[1.2rem] mt-4 font-bold flex justify-center items-center hover:bg-blue-600 transition-all ease-in duration-300' onClick={props.SubmitForm}><Link to={''}>Sign Up</Link></button>
                    </div>
                </form>
                <div className="NotUser flex justify-center items-center mt-2">
                    <p className='text-[0.9rem] mx-1'>Already have account ?</p>
                    <Link to={'/login'}><p className='text-[1rem] text-red-500 mx-1 hover:font-semibold'>Login</p></Link>
                </div>
            </div>
        </>
    )
