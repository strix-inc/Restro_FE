...
const ItemList = ({ id, name, size, quantity, cost, index, GeneratedBill }) => {
    ...
    return (
        <>
            <div className="heading grid grid-cols-10">
                <span className='border border-slate-300 flex justify-center items-center  py-1 font-semibold'>{index + 1}</span>
                <span className='col-span-3 border border-slate-300 flex justify-center items-center  py-1 font-semibold'>{name}</span>
                <span className='inWhite border border-slate-300 flex justify-center items-center  py-1 font-medium'>{cost}</span>

                {/* add dropdown if required here  */}
                <span name="size" id="size" className='inWhite flex justify-center items-center py-1 border border-slate-300 text-black outline-none'>{size}</span>
                ...
                <span className='inWhite border border-slate-300 flex justify-center items-center py-1 font-medium'>{cost * quantitySize}</span>
