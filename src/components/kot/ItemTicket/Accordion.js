    ...
    return (
        <>
            <div className={`relative border rounded-md overflow-hidden ${mode === 'black' ? 'border-green-600 bg-transparent text-white' : 'border-slate-300 bg-blue-100'}`}>
                ...
                <div className={`rounded-b-md ${mode === 'black' ? 'bg-gray-600 text-white' : 'bg-slate-100'} max-h-0 overflow-auto peer-checked:max-h-[300px] transition-all ease-in-out duration-500 scrollbar-hide`}>
                    ...
                    <div className='grid grid-cols-5 text-[0.8rem] px-2 font-mono pb-2'>
                        ...
                        <span className='flex justify-center'>Full</span>
